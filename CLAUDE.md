...
- **Aplikasi Flutter-nya ada di repo terpisah:** [iqbalfhz/nadi_mobile](https://github.com/iqbalfhz/nadi_mobile). Temuan dari sisi mobile masuk sebagai **GitHub Issue berlabel `from-mobile`** di repo ini (templatnya di [.github/ISSUE_TEMPLATE/](.github/ISSUE_TEMPLATE/)), bukan lewat berkas markdown.
- **Setiap perubahan `/api/v1` wajib dicatat** di [docs/API-PERUBAHAN.md](https://github.com/iqbalfhz/nadi_mobile/blob/main/docs/API-PERUBAHAN.md) (di repo mobile) dengan label WAJIB / DISARANKAN / INFO — **sebelum** perubahannya di-deploy. Alasannya keras: APK dibagikan langsung ke petugas, tanpa Play Store, jadi **tidak ada pembaruan otomatis**. Aplikasi versi lama akan tetap berjalan di HP berminggu-minggu setelah API-nya berubah. Bentuk lama harus tetap berfungsi sampai sisi mobile sempat menyesuaikan.
