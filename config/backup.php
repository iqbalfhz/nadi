...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * This backup only covers the Penomoran Dokumen module's data
                 * (see 'databases' below + config/database.php's
                 * 'dump.include_tables'), not the whole app — no files are
                 * relevant to that module (no attachments/uploads), so
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. Credentials
             * for 'google' come from Pengaturan > Backup Otomatis in /admin
             * (App\Providers\AppServiceProvider registers the driver), not
             * from this file.
             */
            'disks' => [
                'google',
    ...
    'notifications' => [
        ...
        /*
         * BackupNotifiable overrides routeNotificationForMail() to read the
         * address from Pengaturan > Backup Otomatis (BackupSettings) at
         * send time, so the 'mail.to' value below is an unused fallback.
         */
