...
return [
     ...
     */
    /*
     * Attribute names that must never reach the log, whatever model they
     * appear on. An activity log records old and new values verbatim, so
     * without this an edit to a user or to Pengaturan would write the
     * password hash, the 2FA secret, the kiosk PIN or the Google Drive
     * refresh token into a table built to be read by admins.
     */
